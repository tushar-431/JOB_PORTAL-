        ...
        <Navbar />
         ...
         <div className='flex items-center justify-center max-w-7xl mx-auto'>
          <form onSubmit={submitHandler} className='w-1/2 border border-gray-500 rounded-md p-4 my-10'>
            <h1 className='font-bold text-xl mb-5 text-center text-blue-600 '><span className='underline-offset-2'>Register</span></h1>
            <div className='my-2'>
              <Label>Name</Label>
            ...
            <button type='submit' className='block w-full py-3 my-3 text-white bg-primary hover:bg-primary/90 rounded-md cursor-pointer'>
              Register
            </button>
            )}
            {/* already account then login */}
            <p className='text-gray-500 text-md my-2'>
              Alrady have an account? <Link to="/login" className='text-blue-700 cursor-pointer'>Login</Link>
            </p>
          </form>
