...
const JobCards = ({job}) => {
  ...
  return (
    <div onClick={()=>navigate(`/description/${job._id}`)} className='p-5 rounded-md shadow-md bg-white border border-gray-200 cursor-pointer hover:shadow-2xl hover:shadow-blue-200 hover:p-3'>
        <div>
        ...
        <div className='flex gap-2 items-center mt-4'>
            <Badge className="text-blue-600 font-bold" variant={"ghost"}>{job.position} Position</Badge>
